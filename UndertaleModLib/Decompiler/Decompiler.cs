...
namespace UndertaleModLib.Decompiler
{
    public static partial class Decompiler
    {
        ...
        public static void BuildSubFunctionCache(UndertaleData data)
        {
            ...
            // Use a cache so this only gets calculated once
            if (data == null || data.GlobalFunctions != null)
                return;
            if (!data.IsVersionAtLeast(2, 3))
            {
                // Make an empty instance
                data.GlobalFunctions = new Underanalyzer.Decompiler.GlobalFunctions();
                return;
            }
            ...
            try
            {
                data.GlobalFunctions = new Underanalyzer.Decompiler.GlobalFunctions(GetGlobalScriptCodeEntries(data));
            }
            catch (Exception ex)
            {
        ...
        private static IEnumerable<Underanalyzer.IGMCode> GetGlobalScriptCodeEntries(UndertaleData data)
        {
